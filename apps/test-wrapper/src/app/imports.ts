export const IMPORTS = {
  accordion: () => import('@ngneers/controls/accordion').then(m => m.NgnAccordion),
  accordionPanel: () => import('@ngneers/controls/accordion').then(m => m.NgnAccordionPanel),
  avatar: () => import('@ngneers/controls/avatar').then(m => m.NgnAvatar),
  avatarGroup: () => import('@ngneers/controls/avatar').then(m => m.NgnAvatarGroup),
  breadcrumb: () => import('@ngneers/controls/breadcrumb').then(m => m.NgnBreadcrumb),
  button: () => import('@ngneers/controls/button').then(m => m.NgnButton),
  buttonGroup: () => import('@ngneers/controls/button-group').then(m => m.NgnButtonGroup),
  calendar: () => import('@ngneers/controls/calendar').then(m => m.NgnCalendar),
  checkbox: () => import('@ngneers/controls/checkbox').then(m => m.NgnCheckbox),
  ...
  editInplace: () => import('@ngneers/controls/edit-inplace').then(m => m.NgnEditInplace),
  ...
  inputField: () => import('@ngneers/controls/input-field').then(m => m.NgnInputField),
  maskInput: () => import('@ngneers/controls/mask-input').then(m => m.NgnMaskInput),
  itemView: () => import('@ngneers/controls/item-view').then(m => m.NgnItemView),
  ...
  radioGroup: () => import('@ngneers/controls/radio').then(m => m.NgnRadioGroup),
  radio: () => import('@ngneers/controls/radio').then(m => m.NgnRadio),
  scrollShadow: () => import('@ngneers/controls/scroll-shadow').then(m => m.NgnScrollShadow),
  scroller: () => [
  ...
  selectButton: () => import('@ngneers/controls/select-button').then(m => m.NgnSelectButton),
  slider: () => import('@ngneers/controls/slider').then(m => m.NgnSlider),
  snackbar: () => import('@ngneers/controls/snackbar').then(m => m.NgnSnackbar),
  spinButtons: () => import('@ngneers/controls/spin-buttons').then(m => m.NgnSpinButtons),
  spinner: () => import('@ngneers/controls/spinner').then(m => m.NgnSpinner),
  state: () => import('@ngneers/controls/state').then(m => m.NgnState),
  splitter: () => import('@ngneers/controls/splitter').then(m => m.NgnSplitter),
  splitterPanel: () => import('@ngneers/controls/splitter').then(m => m.NgnSplitterPanel),
  ...
  tableModule: () => import('@ngneers/controls/table').then(m => m.NgnTableModule),
  tableSelectionColumn: () =>
    import('@ngneers/controls/table').then(m => m.NgnTableSelectionColumn),
  tableSortableColumn: () => import('@ngneers/controls/table').then(m => m.NgnTableSortableColumn),
  tableStickyColumn: () => import('@ngneers/controls/table').then(m => m.NgnTableStickyColumn),
  ngnTemplate: () => import('@ngneers/controls/api/ng').then(m => m.NgnTemplate),
  tag: () => import('@ngneers/controls/tag').then(m => m.NgnTag),
  toast: () => import('@ngneers/controls/toast').then(m => m.NgnToast),
  toggleButton: () => import('@ngneers/controls/toggle-button').then(m => m.NgnToggleButton),
