...
@Component({
  selector: 'awd-demo-button-inline',
  ...
  template: `
    <div class="flex flex-col items-start gap-4">
      ...
      <!-- The clear button an awd-input-field renders is exactly this: kind="icon" + inline,
           so it fits the field's line box instead of stretching it. -->
      <awd-input-field label="Adornments use it too" showClearButton class="w-64">
