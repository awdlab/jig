The Message component (`awd-message`) displays a persistent, inline block of
...
```html
<awd-message color="warning">Your trial ends in 3 days.</awd-message>
```
...
the severity at a glance. It accepts the same icon values as `awd-icon`.
