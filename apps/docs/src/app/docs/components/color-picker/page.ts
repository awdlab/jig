import { AwdDocsColorPickerPlayground } from './playground';
...
export const ColorPickerPage: AwdDocsPage = {
  title: `Color Picker`,
  kind: 'tabs',
  tabs: [
    {
    ...
    { kind: 'component', title: 'Playground', component: AwdDocsColorPickerPlayground },
