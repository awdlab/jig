import { JigDocsColorPickerPlayground } from './playground';
...
export const ColorPickerPage: JigDocsPage = {
  title: `Color Picker`,
  kind: 'tabs',
  tabs: [
    {
    ...
    { kind: 'component', title: 'Playground', component: JigDocsColorPickerPlayground },
