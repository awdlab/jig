import { JigDocsNumberInputPlayground } from './playground';
...
export const NumberInputPage: JigDocsPage = {
  title: `Number Input`,
  kind: 'tabs',
  tabs: [
    {
    ...
    },
    {
      kind: 'component',
      title: 'Playground',
      component: JigDocsNumberInputPlayground,
    },
    ...
    { kind: 'single', title: 'A11y', mdFile: 'components/number-input/a11y.md' },
    i18nText(
