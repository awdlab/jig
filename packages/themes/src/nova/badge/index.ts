  ...
  root: {
    ...
    css: ({ v, c }) => css`
      ${c('root')} {
        ...
        background: var(--awd-badge-color, ${v('color.primary.500')});
        /* Adapts to a caller-supplied --awd-badge-color, which can be light. */
        color: ${autoContrast(`var(--awd-badge-color, ${v('color.primary.500')})`)};
