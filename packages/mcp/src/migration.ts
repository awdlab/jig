 ...
 * Syncfusion) onto awd controls. The agent does the rewrites, verifying targets
 * against get_control.
 */
export function registerMigration(server: McpServer, pack: KnowledgePack): void {
  ...
  server.registerTool(
    'list_migration_sources',
    {
      ...
      description:
        'List the source component libraries with a migration map to awd controls, and how ' +
  ...
  server.registerTool(
    'map_component',
    {
      title: 'Map a component to awd',
      description:
        'Map one source-library component onto its awd equivalent, with prop/event mappings ' +
  ...
  server.registerTool(
    'search_migration',
    {
      ...
      description:
        'Find the awd equivalent for a source component or feature by keyword, across one ' +
  ...
  server.registerPrompt(
    'migrate_library',
    {
      title: 'Migrate a library to awd controls',
      description:
        'Guided workflow to migrate from PrimeNG / Angular Material / Syncfusion to awd.',
      argsSchema: {
        ...
        messages: [
          {
            ...
            content: {
              ...
              text:
                ...
                `the awd target + prop/event mapping. Use search_migration when unsure.\n` +
                `3. Before rewriting, confirm the awd target's real inputs with get_control.\n` +
